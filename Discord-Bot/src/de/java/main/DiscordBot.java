...
import de.java.main.files.PropertiesReader;
import de.java.main.listener.AuditListener;
import de.java.main.listener.AutoListener;
import de.java.main.listener.CommandListener;
import de.java.main.listener.EventAuditListener;
...
public class DiscordBot {
	...
	String[] gameStatus = new String[] {"hello world", " Server Admin.", " %member activists online.", " auf %guilds Servern!", "%help"};
	int timerNext = 15;
