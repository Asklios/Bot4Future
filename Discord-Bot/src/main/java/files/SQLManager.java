...
public class SQLManager {
    ...
    public static void onCreate() {
        ...
        LiteSQL.onUpdate("CREATE TABLE IF NOT EXISTS polls(id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, guildid INTEGER, msgid INTEGER, name STRING, description STRING, votesperuser INTEGER, endtime INTEGER, ownerid INTEGER, hidevotes INTEGER)");
