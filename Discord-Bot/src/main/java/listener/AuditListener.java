...
public class AuditListener extends ListenerAdapter {
	...
	public void onGuildBan(GuildBanEvent event) {
		...
		//write ban to xml
		GuildDataXmlReadWrite.writeBan(event.getUser().getIdLong(), event.getGuild().getIdLong());
	}
	...
	public void onGuildUnban(GuildUnbanEvent event) {
		...
		//write unban to xml
		GuildDataXmlReadWrite.writeUnban(event.getUser().getIdLong(), event.getGuild().getIdLong());
	}
